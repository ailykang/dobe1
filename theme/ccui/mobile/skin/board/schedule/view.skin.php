...
<article id="bo_v" style="width:<?php echo $width; ?>">
    <header>
        <h2 id="bo_v_title">
            ...
            <?php } ?>
            <span class="bo_v_tit"><?php echo $view['wr_1']; ?> 님의 
            <?php
    ...
    <section id="bo_v_atc">
		...
		<?php //echo get_view_thumbnail($view['content']); ?>
			...
			<table>
				...
				<tr>
					<th>계좌번호</th>
					<td colspan="3">농협 312-0226-4947-41 김현우(맘연은)</td>
				</tr>
				<tr>
					<th>메모</th>
		...
		<div id="html-content-holder"><br><br>
<span class="bo_v_tit"><?php echo $view['wr_1']; ?> 님 예약 확정표</span>
<table class="customer_information">
				...
				<tr>
					<th>안방천장</th>
					<td><?php echo $write['wr_11']; ?></td>
					<th>안방벽</th>
					<td><?php echo $write['wr_12']; ?></td>
				</tr>
				<tr>
					<th>부엌후방천장</th>
					<td><?php echo $write['wr_13']; ?></td>
					<th>부엌후방벽</th>
					<td><?php echo $write['wr_14']; ?></td>
				</tr>
				<tr>
					<th>입구방천장</th>
					<td><?php echo $write['wr_15']; ?></td>
					<th>입구방벽</th>
					<td><?php echo $write['wr_16']; ?></td>
				</tr>
				<tr>
					<th>입구방천장</th>
					<td><?php echo $write['wr_17']; ?></td>
					<th>입구방벽</th>
					<td><?php echo $write['wr_18']; ?></td>
				</tr>
				<tr>
					<th>거실/부엌천장</th>
					<td><?php echo $write['wr_19']; ?></td>
					<th>거실/부엌 벽</th>
					<td><?php echo $write['wr_20']; ?></td>
				</tr>
				<tr>
				...
				<tr>
					<th>안방</th>
					<td><?php echo $write['wr_21']; ?></td>
					<th>부엌후방</th>
					<td><?php echo $write['wr_22']; ?></td>
				</tr>
				<tr>
					<th>입구방</th>
					<td><?php echo $write['wr_23']; ?></td>
					<th>거실/부엌</th>
					<td><?php echo $write['wr_24']; ?></td>
				</tr>
				<tr>
					<th colspan="4">금액 및 상담 상태</th>
				</tr>
				<tr>
					<th>금액</th>
					<td><?php echo number_format($write['wr_9']); ?></td>
					<th>결제방법</th>
					<td><?php echo $write['wr_10']; ?></td>
				</tr>
				<tr>
					<th>상담현황</th>
					<td colspan="3"><?php echo $write['wr_25']; ?></td>
				</tr>
<tr>
<th colspan="4" style="border-right: 0;font-weight: 900;font-size: 1.5em;padding: 40px 0;letter-spacing:-1px;">도배드라마를 찾아주셔서 진심으로 감사드립니다.<p style="
    text-align: center;
    font-size: 14px;
">예약확정일 : <?php echo date("Y-m-d", strtotime($view['wr_datetime'])); ?></p></th>
</tr>
    ...
    <input id="btn-Preview-Image" type="button" class="btn_b01 btn" value="예약확정표 미리보기">
    <a class="btn_b02 btn" style="text-decoration:none; color:#fff; font-weight:900;" id="btn-Convert-Html2Image" href="#"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> 예약확정표 출력</a>
    <br/>
    <div id="previewImage" style="padding: 50px 0;"></div>
<script>
...
var getCanvas; // global variable
    ...
    $("#btn-Convert-Html2Image").attr("download", "예약확정표.png").attr("href", newData);
	});
    ...
    <div id="bo_v_top">
	    ...
	    <ul class="bo_v_com">
		 <?php if ($update_href) { ?><li><a href="<?php echo $update_href ?>" class="btn_b01 btn"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> 수정 및 예약확정표 기재</a></li><?php } ?>
