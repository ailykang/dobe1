...
<section id="bo_w">
    ...
    <div class="form_01 write_div">
        ...
        <?php if ($gr_id == "admin") { //자동등록방지 ?>
            <input type="text" name="wr_1" value="<?php echo $write['wr_1'] ?>" id="wr_1" class="frm_input full_input" placeholder="여분필드1">
            <input type="text" name="wr_2" value="<?php echo $write['wr_2'] ?>" id="wr_2" class="frm_input full_input" placeholder="여분필드2">
        <?php } ?>
        <div class="write_div">
